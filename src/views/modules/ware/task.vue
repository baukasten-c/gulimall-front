<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="consigneeTel" header-align="center" align="center" label="收货人电话" width="100px">
      </el-table-column>
      ...
      <el-table-column prop="taskComment" header-align="center" align="center" label="工作单备注" width="100px">
      </el-table-column>
