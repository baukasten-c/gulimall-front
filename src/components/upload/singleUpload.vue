<template> 
  <div>
    <el-upload action="http://guli-mall--oss.oss-cn-beijing.aliyuncs.com" :data="dataObj" list-type="picture"
      ...
      <el-button size="small" type="primary">点击上传</el-button><span slot="tip">&nbsp;&nbsp;&nbsp;只能上传jpg/png文件，且不超过10MB</span>
    </el-upload>
